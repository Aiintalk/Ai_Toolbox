...
| 步骤 | 测试项 | 操作说明 | 预期结果 | 状态 |
|------|--------|----------|----------|------|
| Step 1 | 人设列表加载 | 进入页面，查看人设列表是否正常展示 | 列表显示所有可用人设，含名称和简介 | ⬜ |
| Step 1 | 选择人设 | 点击任意人设 | 成功加载 soul.md 和内容规划，页面显示人设详情 | ⬜ |
| Step 2 | 上传产品文档 | 上传 PDF / Word / Excel / PPT / TXT 格式文件 | 文件上传成功，AI 返回种草向卖点提炼结果 | ⬜ |
| Step 2 | 卖点迭代 | 对提炼结果追加需求进行调整 | AI 根据追加需求重新生成卖点 | ⬜ |
| Step 2 | 确认卖点 | 确认卖点结果，进入下一步 | 成功进入 Step 3 | ⬜ |
| Step 3 | 视频链接输入 | 输入抖音种草视频分享链接 | 成功抓取视频信息 | ⬜ |
| Step 3 | 视频转录 | 等待视频转录完成 | 返回完整文案文本 | ⬜ |
| Step 3 | 结构分析 | 查看 AI 对标视频结构分析结果 | 显示视频内容结构拆解 | ⬜ |
| Step 3 | 主题选择 | 选择主题：沿用 / 自定义 / AI 推荐 | 主题设置成功，进入 Step 4 | ⬜ |
| Step 4 | 脚本生成 | 等待 AI 生成种草脚本 | 流式输出种草风格脚本，内容包含真实体验感和情绪表达 | ⬜ |
| Step 4 | 多轮迭代 | 追加需求修改脚本 | AI 根据需求重新生成脚本 | ⬜ |

> 状态标记：⬜ 未测试 / ✅ 通过 / ❌ 未通过

## 10. 文档更新说明

- **2026-04-19**：新增「流程功能测试」章节
